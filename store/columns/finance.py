...
REGISTRY.define("initial_fx", float,
    description="Initial FX rate for cross-currency swaps",
    role="measure", unit="ratio",
    category="fx",
)

REGISTRY.define("exchange_notional", bool,
    description="Flag for notional exchange in XCCY swaps",
    role="attribute",
    category="fixed_income",
)

REGISTRY.define("leg1_notional", float,
    description="Notional of the first leg",
    role="measure", unit="USD",
    category="fixed_income",
)

REGISTRY.define("leg2_notional", float,
    description="Notional of the second leg",
    role="measure", unit="USD",
    category="fixed_income",
)

REGISTRY.define("leg1_currency", str,
    description="Currency of the first leg",
    role="dimension",
    category="fx",
)

REGISTRY.define("leg2_currency", str,
    description="Currency of the second leg",
    role="dimension",
    category="fx",
)

REGISTRY.define("leg1_discount_curve", object,
    description="Discount curve for leg 1",
    role="attribute",
    category="fixed_income",
)

REGISTRY.define("leg1_projection_curve", object,
    description="Projection curve for leg 1",
    role="attribute",
    category="fixed_income",
)

REGISTRY.define("leg2_discount_curve", object,
    description="Discount curve for leg 2",
    role="attribute",
    category="fixed_income",
)

REGISTRY.define("leg2_projection_curve", object,
    description="Projection curve for leg 2",
    role="attribute",
    category="fixed_income",
)
...
REGISTRY.define("leg1_float_leg_pv", float, description="PV of leg 1", role="measure", unit="USD", category="fixed_income")
REGISTRY.define("leg2_float_leg_pv", float, description="PV of leg 2", role="measure", unit="USD", category="fixed_income")
