...
class SubscriptionListener:
    ...
    def start(self) -> None:
        ...
        Includes a 5-second retry loop to handle slow-starting ARM/WSL databases.
        """
        self._stop_event.clear()
        
        # Retry loop for connection (ARM/WSL startup resilience)
        import time
        last_error = None
        ...
        if self._conn is None:
            raise RuntimeError(f"SubscriptionListener failed to connect to PostgreSQL after 5s: {last_error}")
