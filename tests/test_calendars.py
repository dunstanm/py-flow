...
from pricing.dates.calendars import CalendarFactory, BusinessCalendar
...
def test_compare_with_quantlib(ccy):
    ...
    """
    MAP_TO_YAML = {"USD": "US", "EUR": "TARGET", "GBP": "GB", "JPY": "JP", "AUD": "AU", "CAD": "CA", "CHF": "CH", "SGD": "SG", "DE": "DE"}
    py_cal = CalendarFactory.get_calendar(MAP_TO_YAML.get(ccy, ccy))
    ...
    ql_hols = ql_cal.holidayList(start_date, end_date)
