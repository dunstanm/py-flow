...
# ---------------------------------------------------------------------------
_SCHED_FILE = pathlib.Path(__file__).parent.parent / "pricing" / "instruments" / "ir_scheduling.py"
...
class TestLegacyAPI:
    ...
    def test_legacy_import_path_still_works(self):
        ...
        _p = pathlib.Path(__file__).parent.parent / "pricing" / "instruments" / "ir_scheduling.py"
